...
struct Coint: Identifiable, Codable {
    var id: String?
    var symbol: String?
    var name: String?
    ...
    var priceChangePercentageIn24HInCurrency: Double?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case priceChangePercentageIn24HInCurrency = "price_change_percentage_in_24h_in_currency"
